...
HeaderFooterTextWebKitParser(
    'report.account.account_report_partner_statement_report',
    'account.account',
    'addons/partner_statement_report/report/templates/account_report_partner_statement_report.mako',
