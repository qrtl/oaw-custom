...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Fawo--custom-lightgray.png?logo=github
    :target: https://github.com/qrtl/awo-custom/tree/12.0/website_sale_adj
    :alt: qrtl/awo-custom
...
`feedback <https://github.com/qrtl/awo-custom/issues/new?body=module:%20website_sale_adj%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/awo-custom <https://github.com/qrtl/awo-custom/tree/12.0/website_sale_adj>`_ project on GitHub.
